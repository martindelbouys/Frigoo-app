...
function LoginScreen({ onSignIn, loading }) {
  return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', height:'100svh', gap:28, padding:32, background:'#F6F6F7', fontFamily:"'Plus Jakarta Sans', -apple-system, system-ui, sans-serif" }}>
      <div>
      ...
      <img src="/uploads/penguin-clean.png" alt="" style={{ width:260, maxWidth:'90%', height:'auto' }} />
      <button
        onClick={onSignIn}
        disabled={loading}
...
export default function App() {
  ...
  if (!user) return <LoginScreen onSignIn={signIn} loading={signingIn || user === undefined} />
