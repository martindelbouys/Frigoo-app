...
export default function ListeScreen(p) {
  ...
  }, [p.scrollRef, p.onListTouchMove, p.onListTouchEnd])
  ...
  return (
    <div style={{ height:'100%', display:'flex', flexDirection:'column', background:'#F2F2F2', position:'relative', paddingTop:'env(safe-area-inset-top)' }}>
      ...
      <div ref={p.scrollRef} className="fg-scroll" style={{ flex:1, overflowY:'auto' }}>
        {/* Logo + sélecteur de liste */}
        <div style={{ background:'#FFE7DF' }}>
          <div style={{ paddingTop:14, paddingLeft:16, paddingRight:16, paddingBottom:14 }}>
        ...
        {p.listDropOpen && (
          <div style={{ background:'#FFE7DF', padding:'14px 14px 16px' }}>
            {p.myLists.map((l, i) => (
        ...
        {/* Search bar — épinglée en haut du scroll une fois atteinte, sous le
            sélecteur de liste et au-dessus des catégories */}
        <div style={{ position:'sticky', top:0, zIndex:15, background:'#fff', padding:'12px 16px 10px', borderBottom:'1px solid #F0F0F0' }}>
        ...
        {p.searching ? (
          ...
          <>
            {/* Category pills */}
            <div className="fg-scroll" style={{ display:'flex', gap:8, overflowX:'auto', padding:'12px 16px 11px', background:'#F2F2F2', borderBottom:'1px solid #ECECEC' }}>
