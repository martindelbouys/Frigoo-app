export default function FrigoOverlay(p) {
  return (
    <div style={{ position:'absolute', inset:0, zIndex:40, background:'#F6F6F7', display:'flex', flexDirection:'column' }}>
      <div style={{ background:'linear-gradient(180deg,#EAF4FB,#fff)', padding:'16px 16px 14px', paddingTop:'max(54px, calc(env(safe-area-inset-top) + 14px))', borderBottom:'1px solid #F0F0F0', flexShrink:0 }}>
      ...
      <div className="fg-scroll" style={{ flex:1, overflowY:'auto', padding:'14px 16px 24px' }}>
        {p.fridgeEmpty && (
          <div style={{ display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', padding:'40px 12px' }}>
            <img src="/uploads/penguin-fridge-cropped.png" alt="Frigoo" style={{ width:'100%', maxWidth:300, height:'auto', display:'block' }} />
        ...
        {p.fridgeNotEmpty && (
          <>
            ...
            <div style={{ display:'flex', flexDirection:'column', alignItems:'center', padding:'26px 0 8px' }}>
              <img src="/uploads/penguin-fridge.png" alt="Frigoo" style={{ width:'80%', maxWidth:290, height:'auto', display:'block' }} />
