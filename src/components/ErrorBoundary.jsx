...
export default class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', height:'100%', gap:20, padding:32, background:'#F2F2F2', fontFamily:"'Plus Jakarta Sans', -apple-system, system-ui, sans-serif", textAlign:'center' }}>
